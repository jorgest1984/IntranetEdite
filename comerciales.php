...
$stmt = $pdo->query("SELECT u.*, 'Comercial' as rol_nombre 
                     FROM usuarios u 
                     WHERE u.rol_id = 5
                     ORDER BY u.activo DESC, u.username ASC");
$usuarios = $stmt->fetchAll();

// Listado de roles para el combo no necesario
$roles = [];
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Gestión de Comerciales - <?= APP_NAME ?></title>
    ...
    <main class="main-content">
        <header class="page-header">
            <div class="page-title">
                ...
                <p>Gestión de consultores de formación comerciales</p>
            </div>
        </header>
        ...
        <div class="split-layout">
            ...
            <section class="form-section">
                <h2 style="margin-top: 0; font-size: 1.1rem; color: var(--primary-color);">Alta de Nuevo Comercial</h2>
                <form method="POST">
                    ...
                    <!-- Rol no visible, forzado en backend -->
