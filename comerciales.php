...
<div class="app-container">
    ...
    <main class="main-content">
        ...
        <div class="home-container" style="padding: 0; margin-top: 2rem;">
            ...
            <section class="dashboard-widgets" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 1.5rem;">
                
                <!-- Tarjeta EMPRESAS -->
                <div class="widget">
                    <div class="widget-header">
                        <h2 class="widget-title">Empresas</h2>
                    </div>
                    <div class="widget-body" style="padding: 1.5rem;">
                        <div class="tiles-grid" style="grid-template-columns: repeat(auto-fill, minmax(140px, 1fr));">
                ...
                <div class="widget">
                    <div class="widget-header">
                        <h2 class="widget-title">Trabajadores</h2>
                    </div>
                    <div class="widget-body" style="padding: 1.5rem;">
                        <div class="tiles-grid" style="grid-template-columns: repeat(auto-fill, minmax(140px, 1fr));">
                            <a href="#" class="tile tile-blue">
                                ...
                                <div class="tile-title">Buscador</div>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget">
                    <div class="widget-header">
                        <h2 class="widget-title">Acciones Formativas</h2>
                    </div>
                    <div class="widget-body" style="padding: 1.5rem;">
                        <div class="tiles-grid" style="grid-template-columns: repeat(auto-fill, minmax(140px, 1fr));">
                            <a href="#" class="tile tile-blue">
                                ...
                                <div class="tile-title">Ver Acciones</div>
                            </a>
                        </div>
                    </div>
                </div>
