...
<head>
    <meta charset="UTF-8">
    <title>Objetivos de Acciones Formativas - <?= APP_NAME ?></title>
...
<div class="page">
    <div class="header">
        ...
        <div class="header-title">OBJETIVOS ACCIONES FORMATIVAS</div>
    </div>
    ...
    <div class="content-heading">OBJETIVOS</div>
