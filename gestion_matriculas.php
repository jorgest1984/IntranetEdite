        ...
        <header class="page-header" style="margin-bottom: 30px;">
            ...
            <div style="display: flex; gap: 10px; align-items: center;">
                ...
                <?php if (!empty($alumnos)): ?>
                    <a href="exportar_fundae_alta_xml.php?grupo_id=<?= $grupo_id ?>" target="_blank" class="btn" style="background: #f59e0b; color: white; border: none; font-weight: 700; padding: 10px 15px; border-radius: 8px; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; font-size: 0.85rem; text-decoration: none;">
