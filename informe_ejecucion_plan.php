        ...
        <main class="main-content" style="flex: 1; overflow-y: auto;">
            ...
            <div class="search-card">
                <div class="card-header-custom">
                    <h2 style="color:var(--title-red); margin:0; font-size:1.1rem; font-weight:800;">INFORME DE EJECUCIÓN DE PLAN</h2>
                </div>
                <form class="search-form" method="GET">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="informe_ejecucion_plan.php" class="btn-limpiar" style="text-decoration: none; display: inline-flex; align-items: center;">Eliminar filtros</a>
                    </div>
                </form>
            </div>
