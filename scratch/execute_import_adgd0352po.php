...
if (!$convocatoria_id) {
    // Buscar la convocatoria vinculada al grupo o a la AF
...
foreach ($alumnosData as $item) {
    ...
    if ($alumno) {
        $alumno_id = $alumno['id'];
        // Actualizar datos del alumno sin cambiar email (si ya tiene uno o si no tiene)
        ...
        // Insertar alumno nuevo sin email (email = NULL)
