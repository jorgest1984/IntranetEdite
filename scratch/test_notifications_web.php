<?php
// scratch/test_notifications_web.php
// Script de prueba vía web para enviar las 4 plantillas de correo a jorge@estaciondiseno.es
...
echo "<html><head><title>Prueba de Correos</title></head><body style='font-family: Arial, sans-serif; padding: 20px; line-height: 1.6;'>";
echo "<h2>=== INICIANDO ENVÍO DE CORREOS DE PRUEBA ===</h2>";
echo "<p><strong>Destinatario:</strong> $test_email</p><hr>";
...
if (send_smtp_email($test_email, $subject1, $body1)) {
    echo "<b style='color: green;'>¡Enviado con éxito!</b><br>";
} else {
    echo "<b style='color: red;'>FALLÓ.</b> (Verifica si el servidor tiene bloqueadas las conexiones de correo saliente)<br>";
}
...
if (send_smtp_email($test_email, $subject2, $body2)) {
    ...
    echo "<b style='color: red;'>FALLÓ.</b><br>";
}
...
echo "<hr><h3>=== PRUEBA FINALIZADA ===</h3>";
echo "</body></html>";
