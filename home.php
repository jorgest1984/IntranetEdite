...
$sections = [
    'Inicio' => array_filter([
        ['title' => 'Escuela de Formación Profesional', 'icon' => '<svg viewBox="0 0 24 24"><path d="M11 17h2v-6h-2v6zm1-15C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM11 9h2V7h-2v2z"/></svg>', 'url' => 'edite_formacion.php', 'color' => 'blue'],
    ...
    'Áreas' => array_filter([
        ...
        (!has_permission([ROLE_COMERCIAL, ROLE_JEFE_COMERCIAL]) ? ['title' => 'Informática', 'icon' => '<svg viewBox="0 0 24 24"><path d="M20 18c1.1 0 1.99-.9 1.99-2L22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2H0v2h24v-2h-4zM4 6h16v10H4V6z"/></svg>', 'url' => '#', 'color' => 'blue'] : null),
        (has_permission([ROLE_ADMIN, ROLE_COORD, ROLE_COMERCIAL, ROLE_JEFE_COMERCIAL]) ? ['title' => 'Gestión Comercial', 'icon' => '<svg viewBox="0 0 24 24"><path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/></svg>', 'url' => 'comerciales.php', 'color' => 'blue'] : null)
    ]),
    'Sitios y aplicaciones' => [
        ...
        ['title' => 'Aula Virtual', 'icon' => '<svg viewBox="0 0 24 24"><path d="M12 3L1 9l4 2.18v6L12 21l7-3.82v-6l2.12-1.15V17h2V9L12 3zm6.82 6L12 12.72 5.18 9 12 5.28 18.82 9zM17 15.99l-5 2.73-5-2.73v-3.72l5 2.73 5-2.73v3.72z"/></svg>', 'url' => (defined('MOODLE_AULA_VIRTUAL_URL') ? MOODLE_AULA_VIRTUAL_URL : 'https://aulavirtual.grupoefp.es/'), 'color' => 'blue', 'external' => true]
    ]
];
?>
<!DOCTYPE html>
        ...
        <div id="tab-panel" class="tab-pane">
            ...
            <div class="home-section" style="margin-bottom: 2rem;">
                ...
                <div class="tiles-grid" style="grid-template-columns: repeat(auto-fill, minmax(200px, 1fr));">
                    ...
                    <!-- Inspectores -->
                    <a href="conexion_inspectores.php" class="tile tile-danger">
                        <div class="tile-icon">
