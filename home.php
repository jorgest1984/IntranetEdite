...
$sections = [
    ...
    'Áreas' => array_filter([
        ...
        (!has_permission([ROLE_COMERCIAL]) ? ['title' => 'Informática', 'icon' => '<svg viewBox="0 0 24 24"><path d="M20 18c1.1 0 1.99-.9 1.99-2L22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2H0v2h24v-2h-4zM4 6h16v10H4V6z"/></svg>', 'url' => '#', 'color' => 'blue'] : null),
        (has_permission([ROLE_ADMIN, ROLE_COORD, ROLE_COMERCIAL]) ? ['title' => 'Gestión Comercial', 'icon' => '<svg viewBox="0 0 24 24"><path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/></svg>', 'url' => 'comerciales.php', 'color' => 'blue'] : null)
    ]),
