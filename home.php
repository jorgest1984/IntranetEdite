...
echo "<!-- VERSION: 2.0 - FORMACION LINK UPDATED -->";
...
$sections = [
    'Inicio' => [
        ...
        ['title' => 'Formación Profesional [DEBUG]', 'icon' => '<svg viewBox="0 0 24 24"><path d="M12 3L1 9l4 2.18v6L12 21l7-3.82v-6l2.12-1.15V17h2V9L12 3zm6.82 6L12 12.72 5.18 9 12 5.28 18.82 9zM17 15.99l-5 2.73-5-2.73v-3.72l5 2.73 5-2.73v3.72z"/></svg>', 'url' => 'formacion_profesional.php', 'color' => 'red'],
