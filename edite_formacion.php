...
$sections = [
    ...
    'Ayúdanos a mejorar' => [
        ['title' => 'Buzón de sugerencias', 'icon' => '<svg viewBox="0 0 24 24"><path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7zm2.85 11.1l-.85.6V16h-4v-2.3l-.85-.6A4.997 4.997 0 0 1 7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 1.63-.8 3.16-2.15 4.1z"/></svg>', 'url' => 'sugerencias.php', 'color' => 'red'],
        ['title' => 'Política de igualdad', 'icon' => '<svg viewBox="0 0 24 24"><path d="M19 10H5v-2h14v2zm0 6H5v-2h14v2z"/></svg>', 'url' => 'politica_igualdad.php', 'color' => 'red'],
    ],
    'Otra información de interés' => [
        ['title' => 'Teléfonos', 'icon' => '<svg viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>', 'url' => 'telefonos.php', 'color' => 'red'],
        ['title' => 'Redes WiFi', 'icon' => '<svg viewBox="0 0 24 24"><path d="M1 9l2 2c5.33-5.33 13.67-5.33 19 0l2-2c-6.67-6.67-17.33-6.67-24 0zm8 8l3 3 3-3c-1.66-1.66-4.34-1.66-6 0zm-4-4l2 2c2.76-2.76 7.24-2.76 10 0l2-2C15.14 9.14 8.87 9.14 5 13z"/></svg>', 'url' => 'redes_wifi.php', 'color' => 'red'],
        ['title' => 'Calendario laboral', 'icon' => '<svg viewBox="0 0 24 24"><path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z"/></svg>', 'url' => 'calendario.php', 'color' => 'red'],
        ['title' => 'Modelo solicitud vacaciones', 'icon' => '<svg viewBox="0 0 24 24"><path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zM7 10h5v5H7z"/></svg>', 'url' => 'https://www.editeformacion.com/gestion/public/docs/modelo-solicitud-vacaciones.pdf', 'color' => 'red', 'external' => true],
    ]
];
?>
<!DOCTYPE html>
