...
if (empty($alumnos)) {
    ...
    foreach ($alumnos as $alumno) {
        ...
        $initial = $alumno['moodle_e1_grade'] !== null ? number_format(floor((float)$alumno['moodle_e1_grade']), 0) : '---';
        $intermediate = $alumno['moodle_e2_grade'] !== null ? number_format(floor((float)$alumno['moodle_e2_grade']), 0) : '---';
        $final = $alumno['moodle_e3_grade'] !== null ? number_format(floor((float)$alumno['moodle_e3_grade']), 0) : '---';
