                                ...
                                <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s;">
                                    ...
                                    <td data-label="Acciones" style="padding: 15px;">
                                        <div style="display: flex; gap: 8px; justify-content: center;">
                                            ...
                                            <a href="borrar_af.php?id=<?= $row['id'] ?>" class="btn-action" style="color: #ef4444;" title="Borrar Acción Formativa" onclick="return confirm('¿Seguro que deseas eliminar esta Acción Formativa? Esta acción no se puede deshacer y eliminará sus grupos y matrículas.');">
