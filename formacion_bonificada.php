<?php
// formacion_bonificada.php
require_once 'includes/auth.php';

// Definición de las secciones según la imagen solicitada
$sections = [
    [
        'title' => 'Empresas',
        'url' => 'empresas.php',
    ...
    [
        ...
        'url' => 'acciones_formativas.php',
        'icon' => '<svg viewBox="0 0 24 24"><path d="M12 3L1 9l4 2.18v6L12 21l7-3.82v-6l2-1.09V17h2V9L12 3zm6.82 6L12 12.72 5.18 9 12 5.28 18.82 9zM17 15.99l-5 2.73-5-2.73v-3.72l5 2.73 5-2.73v3.72z" fill="white"/></svg>'
    ]
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Formación Bonificada - Grupo EFP</title>
    ...
    <main class="main-content">
        <header class="page-header">
            <div class="page-title">
                <h1>Formación Bonificada</h1>
                <p>Gestión de empresas, trabajadores y acciones formativas subvencionadas</p>
            </div>
        ...
        <!-- Información adicional o avisos si fuera necesario -->
        <div style="margin-top: 3rem; text-align: center; color: var(--text-muted); font-size: 0.9rem;">
            <p>Seleccione una categoría para acceder a la gestión correspondiente.</p>
        </div>
    </main>
</div>
